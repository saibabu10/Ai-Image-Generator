...
const CreatePost = () => {
  ...
  <section className='max-w-7xl mx-auto'>
    <div>
            ...
            <p className='mt-2 text-[#666e75] text-[14px] max-w[500px]'>Create imaginative and visually stunning images generated by AI</p>
        </div>
        ...
        <div className='mt-10'>
            <p>Once you have created the image that you desire, it's possible to share it with other members of the community.</p>
            <button
            typr="submit"
